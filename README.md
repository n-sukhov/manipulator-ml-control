...
Обозначим также целевые точки $G_m$, в которые должны прийти определённые сочленения робота (не все, а, например, только конечные). Индексы $I\subseteq\{1,\dots,n\}$ соответствуют номерам сочленений, к которым относятся целевые точки: $G_m=(x_m^*,y_m^*)\in\mathbb{R}^2,\ m\in I$. И расстояния между целевыми точками и сочленениями: $l_m=\|J_m-G_m\|_2,\ m\in I,\ L=\{l_m\mid m\in I\}$. Если $m,m+1\in I$, то $\|G_{m+1}-G_m\|_2=d_m$, где $d_m$ — длина звена между $J_m$ и $J_{m+1}$. 
